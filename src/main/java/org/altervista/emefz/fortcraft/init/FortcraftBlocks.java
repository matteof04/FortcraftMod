...
package org.altervista.emefz.fortcraft.init;

import net.minecraftforge.fml.common.registry.GameRegistry;
import org.altervista.emefz.fortcraft.Fortcraft;
import org.altervista.emefz.fortcraft.blocks.LootBoxBlock;

@GameRegistry.ObjectHolder(Fortcraft.MODID)
public class FortcraftBlocks {
    public static final LootBoxBlock LOOT_BOX = null;
}
